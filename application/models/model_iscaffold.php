...
*/         		
        ...
        */
        ...
        $fields_string 	   = '';
        $raw_fields_string = '';
        $fields_array_custom_post  = 'array(';
        ...
        $fields_array_custom_post = $fields_array_custom_post . "\n);";
        ...
        */
        ...
        foreach ( $fields as $key => $field )
        {
            ...
            // SKIP 'Virtual fields'
            //$raw_fields_string .= ( $this->table_config[$key]['sf_type'] == 'many_related' ) ? '' : $separator . $field;
            $fields_array_custom_put      .= $separator . "\n\t'" . $field . "' => \$this->put('" . $field . "')";
        }

        $fields_array_custom_put = $fields_array_custom_put . "\n);";
		...
		**/
		...
		$name_controller_lower 	= strtolower( $name_table );
                        ...
                        $model_related  .= "\tfunction related_$rel_data[0]()
    {
		...
		**/
        ...
        //Generate API CONTROLLER templates
        ...
        $code_controller = read_file( $data_path['input_controller_api'] . 'controller.php' );
        ...
        $code_controller = str_replace( "%NAME_CONTROLLER_LOWER%", 	$name_controller_lower,   $code_controller ); // Added

        $code_controller = str_replace( "%NAME_MODEL_LOWER%", 	$name_model_lower,  $code_controller );

        $code_controller = str_replace( "%FIELDS_ARRAY_CUSTOM_POST%", 	$fields_array_custom_post,      $code_controller ); // Added
        $code_controller = str_replace( "%FIELDS_ARRAY_CUSTOM_PUT%", 	$fields_array_custom_put,      $code_controller ); // Added
        ...
        $file_controller = $data_path['output_controller_api'] . $name_table . '.php';
        write_file( $file_controller, $code_controller );
        ...
        **/                 		
        ...
        /**
        Generate API MODEL templates
         **/
        $code_model = read_file( $data_path['input_model_api'] . 'model.php' );
        ...
        $file_model = $data_path['output_model_api'] . 'model_' . $name_table . '.php';
        write_file( $file_model, $code_model );
