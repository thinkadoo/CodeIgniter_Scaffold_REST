...
class Generate extends CI_Controller  {
	...
	function create( $database )
	{
		...
		{		
            ...
            $path_input_controller_api  = $path_templates . 'controllers/api/'; // Added
			$path_input_model			= $path_templates . 'models/';
			$path_input_model_api		= $path_templates . 'models/api/'; // Added
            ...
            $path_output_controller_api = $path_output . 'application/controllers/api/';  // Added
			$path_output_model	        = $path_output . 'application/models/';
			$path_output_model_api		= $path_output . 'application/models/api/'; // Added
            ...
            mkdir( $path_output_controller_api , 0777 ); // Added
			mkdir( $path_output_model 		, 0777 );
			mkdir( $path_output_model_api 	, 0777 ); // Added
            ...
            $data_path['input_controller_api'] 	= $path_input_controller_api;  // Added
			$data_path['input_model'] 		= $path_input_model;
			$data_path['input_model_api'] 	= $path_input_model_api; // Added
			$data_path['input_view'] 		= $path_input_view;

			$data_path['output_controller'] = $path_output_controller;
            $data_path['output_controller_api'] = $path_output_controller_api;  // Added
			$data_path['output_model'] 		= $path_output_model;
			$data_path['output_model_api'] 	= $path_output_model_api; // Added
